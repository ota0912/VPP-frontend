...
const Hamburger = ({setHamOpen}:hamburgerProps) => {
  return (
    <div data-aos="fade-up" data-aos-duration="300" className="top-[3.25rem] absolute w-full menu-height bg-black z-50 flex flex-col justify-start items-center gap-8 py-8" onClick={()=>{setHamOpen(false)}}>
