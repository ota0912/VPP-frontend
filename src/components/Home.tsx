...
const Home:React.FC = () => {
  return (
    <div id="home" className="px-40 py-36 flex flex-row justify-evenly gap-24 max-xl:flex-col max-xl:text-center max-xl:items-center max-xl:gap-12 max-xl:py-20 max-xl:px-20 max-sm:px-8 max-sm:py-8 max-sm:gap-4">
      <div>
