...
const Footer = () => {
  return (
    <div className="bg-black flex flex-row justify-center py-12 px-40 gap-32 items-center mt-20 max-xl:px-20 max-lg:px-0 max-lg:gap-16 max-sm:flex-col max-sm:items-center max-sm:gap-6  max-lg:mt-4 absolute -z-10">
